...
<main class="w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-white-800">Cập nhật: {{ $post->title }}</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="md:col-span-2 space-y-6">
                        <div>
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $post->title) }}" required
                                class="w-full rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 border p-2 text-base text-gray-900 @error('title') border-red-500 @else border-gray-300 @enderror"
                        ...
                        <div>
                            ...
                            <textarea name="summary" id="summary" rows="3"
                                class="w-full rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 border p-2 text-gray-900 @error('summary') border-red-500 @else border-gray-300 @enderror"
                    ...
                    <div class="space-y-6">
                        <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                            ...
                            <select name="category_id" id="category_id" class="w-full rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 border p-2 bg-white text-gray-900 @error('category_id') border-red-500 @else border-gray-300 @enderror">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                            ...
                            <input type="number" name="priority" id="priority" value="{{ old('priority', $post->priority) }}" min="0"
                                class="w-full rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 border p-2 bg-white text-gray-900 @error('priority') border-red-500 @else border-gray-300 @enderror">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                            ...
                            @if($post->thumbnail)
                                <div class="mb-3 text-center">
                                    ...
                                    <img src="{{ $post->thumbnail }}" alt="Current Image" class="mx-auto max-h-32 rounded border border-gray-300">
                                </div>
                            @endif
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                            ...
                            <p class="text-xs text-gray-500 mt-2">
                                <a href="https://www.google.com/maps" target="_blank" class="text-blue-600 hover:underline">Mở Google Maps</a>
                            </p>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                            ...
                            <select name="related_ids[]" id="related_ids" multiple
                                class="w-full h-32 rounded-md shadow-sm border-gray-300 border p-2 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500">
                                @if(isset($allPosts) && $allPosts->count() > 0)
                                    ...
                                    @endforeach
                                @else
                                    <option disabled>Không có bài viết khác</option>
                                @endif
                            </select>
                            <p class="text-xs text-gray-500 mt-1">Giữ phím <strong>Ctrl</strong> để chọn nhiều bài.</p>
                            @error('related_ids') <p class="text-red-500 text-xs mt-1 italic">{{ $message }}</p> @enderror
                        </div>

                        <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded shadow transition duration-200 flex justify-center items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
