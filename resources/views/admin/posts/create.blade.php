                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="latitude" id="latitude" value="{{ old('latitude') }}"
                                        class="w-full rounded-lg shadow-sm border p-2 text-sm text-gray-900 focus:ring-indigo-500 focus:border-indigo-500 border-gray-300" placeholder="0.000">
                                </div>
                                <div>
                        ...
                        <div class="bg-indigo-50 p-5 rounded-xl border border-indigo-100 shadow-sm">
                            ...
                            <select name="related_ids[]" id="related_ids" multiple
                                ...
                                @if(isset($allPosts) && $allPosts->count() > 0)
                                    ...
                                    @endforeach
                                @else
                                    <option disabled>Chưa có bài viết khác</option>
                                @endif
                            </select>
                        </div>
